...
(async () => {
  const HomeAPIRoutes = {
    "Phim Đang Thịnh Hành": { url: "/trending/movie/week" },
    "Phim Phổ Biến": { url: "/movie/popular" },
    "Phim Đánh Giá Cao": { url: "/movie/top_rated" },
    "Phim Đang Chiếu": { url: "/movie/now_playing" },
    "Phim Sắp Chiếu": { url: "/movie/upcoming" },
  };
  ...
  const trending = data["Phim Đang Thịnh Hành"];
